...
var T=require('@stdlib/assert-is-wasm-memory/dist'),w=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),V=require('@stdlib/utils-inherit/dist'),M=require('@stdlib/wasm-module-wrapper/dist'),k=require('@stdlib/error-tools-fmtprodmsg/dist'),C=m();function o(e){if(!(this instanceof o))return new o(e);if(!T(e))throw new TypeError(k('nullH0',e));return M.call(this,C,e,{env:{memory:e}}),this}V(o,M);w(o.prototype,"main",function(r,i,a,t,n,s){return this._instance.exports.c_sdsdot(r,i,a,t,n,s)});w(o.prototype,"ndarray",function(r,i,a,t,n,s,p,l){return this._instance.exports.c_sdsdot_ndarray(r,i,a,t,n,s,p,l)});x.exports=o
